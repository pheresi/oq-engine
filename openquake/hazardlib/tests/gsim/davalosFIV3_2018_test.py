...
import openquake.hazardlib.gsim.davalosFIV3_2018 as dm
...
class DavalosMiranda2018FIV3TestCase(BaseGSIMTestCase):
    """
    Tests the Davalos and Miranda (2018) GMPE for FIV3
    """
    GSIM_CLASS = dm.DavalosMiranda2018FIV3

	# Tables created from Matlab code from the original authors

    # File containing results for the mean
    MEAN_FILE = "DM_FIV3_2018/DM_FIV3_2018_MEAN.csv"
    # File containing results for the total standard deviation
    STD_FILE = "DM_FIV3_2018/DM_FIV3_2018_TOTAL_STDDEV.csv"
    # File containing results for the inter-event standard deviation
    INTER_FILE = "DM_FIV3_2018/DM_FIV3_2018_INTER_EVENT_STDDEV.csv"
    # File containing results for the intra-event standard deviation
    INTRA_FILE = "DM_FIV3_2018/DM_FIV3_2018_INTRA_EVENT_STDDEV.csv"
