...
import openquake.hazardlib.gsim.davalosSAAVG_2018 as dm
...
class DavalosMiranda2018SAAVGTestCase(BaseGSIMTestCase):
    """
    Tests the Davalos and Miranda (2018) GMPE for SAAVG
    """
    GSIM_CLASS = dm.DavalosMiranda2018SAAVG

	# Tables created from Matlab code from the original authors

    # File containing results for the mean
    MEAN_FILE = "DM_SAAVG_2018/DM_SAAVG_2018_MEAN.csv"
    # File containing results for the total standard deviation
    STD_FILE = "DM_SAAVG_2018/DM_SAAVG_2018_TOTAL_STDDEV.csv"
    # File containing results for the inter-event standard deviation
    INTER_FILE = "DM_SAAVG_2018/DM_SAAVG_2018_INTER_EVENT_STDDEV.csv"
    # File containing results for the intra-event standard deviation
    INTRA_FILE = "DM_SAAVG_2018/DM_SAAVG_2018_INTRA_EVENT_STDDEV.csv"
